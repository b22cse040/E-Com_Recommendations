...
def process_main_query(query: str, model_name: str, ranker_model, tokenizer, embedder, device):
  logs = []
  start_time = time.time()
  raw_json_str = form_response(query, model_name, ranker_model=ranker_model, tokenizer=tokenizer, device=device, embedder=embedder)
